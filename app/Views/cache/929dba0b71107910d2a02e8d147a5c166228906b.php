            ...
            function startQR() {
                html5QrCode.start(
                    ...
                    qrCodeMessage => {
                        ...
                        $.get("<?php echo e(base_url('/stok/delStok')); ?>".concat("/", qrCodeMessage, "/1"), function (data) {
                            alert(data);
                            if (data === 'Barang tidak ditemukkan!') {
                                ...
                                if (data === 'Barang habis!') {
                                    ...
                                    console.log('barang aya')
                                    $.get("<?php echo e(base_url('/laporan/tambah')); ?>".concat("/",qrCodeMessage,'/1/Keluar'));
                                }
                            }
...
<?php /**PATH C:\Users\andre\PhpstormProjects\stockQR\app\Views/QR/barangkeluar/scanjs.blade.php ENDPATH**/ ?>